...
const pencilEraser = document.createElementNS('http://www.w3.org/2000/svg', 'rect');
pencilEraser.setAttribute('x', '9');
pencilEraser.setAttribute('y', '0');
pencilEraser.setAttribute('width', '6px');
pencilEraser.setAttribute('height', '2px');
pencilEraser.setAttribute('transform', 'rotate(58 13 5)');
pencilEraser.style.opacity = '1';
pencilEraser.style.stroke = '#ffffff';
pencilEraser.style.strokeWidth = '0.2';
pencilEraser.style.strokeOpacity = '1';
pencilEraser.style.fill = '#ffffff';
pencilEraser.style.fillOpacity = '1';
pencilEraser.style.strokeLineJoin = 'round';
pencilIcon.appendChild(pencilEraser);
...
pencilShaft.setAttribute('height', '13px');
pencilShaft.setAttribute('transform', 'rotate(58 10 4)');
